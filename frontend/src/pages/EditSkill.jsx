    ...
    <div className="min-h-[80vh] flex items-center justify-center px-4 py-12 bg-slate-900">
      <div className="w-full max-w-xl glass-card rounded-3xl p-8 border border-slate-800">
        <div className="text-center mb-8">
          <h2 className="text-3xl font-extrabold text-white">Edit Skill Details</h2>
          <p className="text-sm text-slate-500 mt-2">Modify your bartered skill's description, level, or category</p>
        </div>
